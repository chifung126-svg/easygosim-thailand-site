...
for (const d of destinations) {
  ...
  fs.writeFileSync(path.join(root,d.slug,'index.html'),polishPurchaseCopy(wireCheckout(thaiHtml,d)),'utf8');
  fs.writeFileSync(path.join(root,'en',d.slug,'index.html'),polishPurchaseCopy(wireCheckout(englishHtml,d)),'utf8');
}
